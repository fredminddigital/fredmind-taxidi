...
export const taxidiStandards = [
  { icon: Shield, title: "Trusted Expertise", text: "Over 10 years of combined experience with 1000+ successful applications globally." },
  { icon: Globe, title: "Worldwide Coverage", text: "Processing applications for 100+ countries across all continents." },
  { icon: CheckCircle2, title: "95% Success Rate", text: "Proven track record with exceptional visa approval rates through expert guidance." },
  { icon: Lightbulb, title: "Transparent Process", text: "Clear communication at every step with no hidden surprises." },
  { icon: Target, title: "African Understanding", text: "We understand African travelers’ unique needs while delivering world class standards." },
  { icon: BadgeCheck, title: "End to End Support", text: "From first contact to successful settlement anywhere in the world." },
];

export const taxidiTestimonials = [
  {
    quote: "Fredmind Taxidi made my dream of studying in the UK a reality. From choosing the right university to getting my visa approved, they were with me every step.",
    name: "Chioma A.",
    meta: "Now studying in London, UK",
    initial: "C",
  },
  {
    quote: "Professional, transparent, and genuinely caring. They handled everything and I’m now settled in Canada with my family.",
    name: "Emmanuel O.",
    meta: "Relocated to Toronto, Canada",
    initial: "E",
  },
  {
    quote: "They prepared me for IELTS, got me admission, processed my visa, and arranged my accommodation.",
    name: "Blessing M.",
...
export const expoExpectations = [
  { icon: GraduationCap, title: "University Fair", text: "Meet admissions reps from 30+ universities in the UK, USA, Canada, Australia and Europe one on one." },
  { icon: Star, title: "Scholarship Showcase", text: "Discover fully funded and partial scholarships available exclusively to African students." },
  { icon: IdCard, title: "Visa Guidance", text: "Certified consultants demystify the student visa process for your destination country." },
  { icon: BookOpen, title: "Live Masterclasses", text: "IELTS, TOEFL, personal statement writing, and application strategy workshops." },
  { icon: BadgeDollarSign, title: "Finance Planning", text: "Education loan resources and financial planning tools for parents and students." },
  { icon: Globe, title: "Alumni Network", text: "Connect with Nigerian and Ghanaian graduates studying abroad and hear real stories." },
];
